    ...
    <div className="loginContainer h-screen bg-[#161b2dca]">
        <div className="loginCard flex flex-col h-[80vh] w-[70vh] bg-[#171b2e] border-1 border-[#4c4c5169] rounded-[10px] flex justify-self-center  m-[1.5rem]">
            <div className="flex flex-col items-center justify-center mx-[2rem] my-[1.25rem]">
              ...
              <h1 className="loginHeading text-3xl font-bold mt-[0.75rem] mb-[1rem] flex justify-center">GET YOUR TICKET</h1>  
              <p className="loginParagraph text-[15px] text-gray-400">Create your own account to start your own list.</p>
            </div>
            ...
            <form className="loginForm flex flex-col mx-[1rem] gap-[1.5rem]">
                ...
                <button type="submit" className="loginButton h-[1.5rem] w-[90%] flex items-center justify-center bg-[#E8B04B] text-[#0F1220] font-semibold border-1 border-gray-700 rounded-[4px] py-[1.25rem] px-[0.5rem] mt-[1.75rem] mx-[1rem]">Create Account</button>
            </form>

            <p className="text-[15px] text-gray-500 mt-[1rem] mb-[1rem] m-auto">Already a member?<Link href="/login" className="text-[#E8B04B] hover:underline m-1">Sign in</Link></p>
