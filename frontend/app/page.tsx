  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-8">
      <header className="flex items-center justify-between mb-10">
        <div>
          <p className=" text-xs tracking-widest text-accent-dim uppercase mb-1  text-nevey to-blue-800 dark:text-white">
            Now Showing
          </p>
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-700 dark:text-white">
            Movie Collection
          </h1>
        </div>
        {!authLoading &&
          (user ? (
            <div className="flex items-center gap-3">
              <span className="hidden sm:block text-sm text-pink-400">
                Hi, {user.name}
              </span>
              <Link
                href="/dashboard"
